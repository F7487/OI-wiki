...
![](https://cdn.luogu.com.cn/upload/image_hosting/7ht8defg.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)

 Rake 操作指定一个度为一的点 $x$ ，而且与点 $x$ 相邻的点 $y$ 的度数需大于一，设点 $y$ 的另一个邻点为 $z$，我们将点 $x$ 、边 $xy$ 的信息放入 边 $yz$ 中储存，并删去它们。 如图所示。
 
 ![](https://cdn.luogu.com.cn/upload/image_hosting/gt23enjv.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
 
不难证明，任何一棵树都可以只用 Compress 操作 和 Rake 操作来将它收缩为一条边，如图所示。

![](https://cdn.luogu.com.cn/upload/image_hosting/2j6u2o19.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/q9cnkav7.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/h6zau69v.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/dypf020i.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/h8cf50up.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/ooc5nx74.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/psu9qkqh.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/oa7gf28z.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/891ubefg.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/7h8qphf4.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/aqm9jcal.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/eqpn0r9l.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/rnx9s6xs.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/6bt6meah.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
![](https://cdn.luogu.com.cn/upload/image_hosting/wlecb78p.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)

![](https://cdn.luogu.com.cn/upload/image_hosting/yv15y3y8.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)

![](https://cdn.luogu.com.cn/upload/image_hosting/vxurwbav.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
...
所以我们就证明了 'access(x)' 的复杂度，而其他函数只不过是常数因子，所以我们就证明了 SATT 的复杂度。

顺便一提，如果你像写 LCT 一样省略 Global Splay 的过程，改为在每次 Splice 时直接将要 Access 的点旋转一下，这样做时间复杂度也是对的（实测省略 global splay 的版本要快很多，能与LCT 在 Luogu P3690 跑得不分上下）。
...
现在我们在根簇
![](https://cdn.luogu.com.cn/upload/image_hosting/pmpcbade.png?x-oss-process=image/resize,m_lfit,h_1000,w_1000)
